  ...
  <div class="row gx-5 align-items-stretch justify-content-center">
    <div class="col-lg-8 col-xl-7 col-xxl-6">
      <div class="my-5 text-center text-xl-start">
        <h1 class="display-5 fw-bolder text-white mb-2">{HERO_TITLE: enwrap=strong}</h1>
        <p class="lead fw-normal text-white-50 mb-4">{HERO_DESCRIPTION: enwrap=span&class=text-bold}</p>
        <ul class="hero-list list-unstyled">  
...
$HERO_TEMPLATE['default']['item'] = '
          <li>
		    <div class="hero-list-icon animated zoomInUp {HERO_ANIMATION_DELAY}">
			  <span class="hero-icon hero-icon-circle hero-icon label-{HERO_ICON_STYLE} bg-{HERO_ICON_STYLE} badge-{HERO_ICON_STYLE} shadow-3dp">{HERO_ICON}</span>
			</div>
			<div class="hero-list-text text-white-50 animated {HERO_ANIMATION} {HERO_ANIMATION_DELAY}">{HERO_TEXT}</div>
		  </li> 
';
...
$HERO_TEMPLATE['default']['end'] = '
        ...
        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
          <a class="btn btn-{HERO_BUTTON1_CLASS} btn-lg px-4 me-sm-3" href="{HERO_BUTTON1_URL}">{HERO_BUTTON1_ICON} {HERO_BUTTON1_LABEL}</a>
          <a class="btn btn-{HERO_BUTTON2_CLASS} btn-lg px-4" href="{HERO_BUTTON2_URL}">{HERO_BUTTON2_ICON} {HERO_BUTTON2_LABEL}</a>
        </div>
      </div>
    </div>      
    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center">
      {SETIMAGE: w=600&h=400}
      {HERO_MEDIA: class=img-fluid rounded-3 my-4 w-100}
    </div> 
  </div>
</div>
';
